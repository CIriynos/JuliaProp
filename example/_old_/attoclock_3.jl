...
# a_tsurf_lm = isurf_sh(pw, rt, phi_record, dphi_record, crt_shwave, At_data_x, At_data_y, At_data_z, Ri_tsurf, t_linspace, k_linspace, TSURF_MODE_ELLI);
# tsurf_plot_xy_momentum_spectrum(a_tsurf_lm, k_space, pw, kr_flag=true)

tau_p = last(t_linspace)
δa_lm = isurf_rest_part(crt_shwave, k_linspace, tau_p, Ri_tsurf, pw, rt)
tsurf_plot_xy_momentum_spectrum(δa_lm, k_space, pw, kr_flag=true)


# store data
# example_name = "attoclock_3"
...
# crt_shwave = retrieve_obj("attoclock_3", "crt_shwave")
# phi_record = retrieve_obj("attoclock_3", "phi_record")
# dphi_record = retrieve_obj("attoclock_3", "dphi_record")
# a_tsurf_lm = retrieve_mat("attoclock_3", "a_tsurf_lm")

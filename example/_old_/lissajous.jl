...
########################
# retrieve data.
crt_shwave = retrieve_obj("lissajous", "crt_shwave")
phi_record = retrieve_obj("lissajous", "phi_record")
dphi_record = retrieve_obj("lissajous", "dphi_record")
a_tsurff_vec = retrieve_mat("lissajous", "a_tsurff_vec")

a_tsurff_vec = isurf_sh_vector(pw, rt, phi_record, dphi_record, crt_shwave, At_data_x, At_data_y, At_data_z, Ri_tsurf, t_linspace, k_space, TSURF_MODE_ELLI);
tsurf_plot_xy_momentum_spectrum_vector(a_tsurff_vec, k_space, kr_flag=true, log_flag=true, min_threhold=1e-4)
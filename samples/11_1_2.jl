...
# # Start Propagation
# hhg_integral_t, phi_record, dphi_record = tdseln_sh_mainloop_record_optimized_hhg(crt_shwave, pw, rt, At_data_z, steps, Ri_tsurf; m = 0, start_rcd_step = start_rcd_step, end_rcd_step = end_rcd_step);

# # Store Data
# example_name = "11_1_2_$(tau)_ratio2"
# h5open("./data/$example_name.h5", "w") do file
#     write(file, "crt_shwave", hcat(crt_shwave...))
#     write(file, "phi_record", hcat(phi_record...))
#     write(file, "dphi_record", hcat(dphi_record...))
#     # write(file, "a_tsurff_vec", hcat(a_tsurff_vec...))
...
hhg_spectrum = norm.(hhg_spectrum_z) .^ 2 #+ norm.(hhg_spectrum_y) .^ 2
...
scatter([-7000, -2850, -1950, -1000], [pp[1], pp[2], pp[3], pp[4]])

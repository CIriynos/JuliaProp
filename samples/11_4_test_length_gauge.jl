...
# Start Propagation
# hhg_integral_t, energy_list = tdseln_sh_mainloop_length_gauge_hhg(crt_shwave, pw, rt, Et_data_z, steps, m = 0)

@time tdseln_sh_mainloop_length_gauge_hhg(crt_shwave, pw, rt, Et_data_z, 2000, m = 0)
1
...
# # Store Data
# example_name = "11_4_test_length_gauge"

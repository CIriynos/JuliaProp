...
# 11_8_3.jl  改THz和恒场大小，再改小！！！顺便改一下延迟计算方法
...
shg_yield_4 = norm.(hhg_spectrum_y)[31]
# plot([norm.(hhg_spectrum_y)[spectrum_range]], yscale=:log10)
# plot([real.(hhg_integral_t) imag.(hhg_integral_t)])

plot(tau_lst, [shg_yield_1, shg_yield_2, shg_yield_3, shg_yield_4, shg_yield_1],
    xlabel="Delay Time τ",

...
# 11_8_4.jl  改THz和恒场大小，和论文中的一致 (50 ~ 100 kV/cm with 600 μJ)
...
hhg_data_4 = norm.(hhg_spectrum_y)
shg_yield4 = norm.(hhg_spectrum_y)[31]
# plot([norm.(hhg_spectrum_x)[spectrum_range]], yscale=:log10)
# plot([real.(hhg_integral_t) imag.(hhg_integral_t)])

plot(tau_lst, [shg_yield1, shg_yield2, shg_yield3, shg_yield4, shg_yield1],
    xlabel="Delay Time τ",

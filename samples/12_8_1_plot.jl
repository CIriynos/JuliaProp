...
push!(hhg_data, norm.(hhg_spectrum_y))
...
p2 = plot([hhg_data[1][spectrum_range] hhg_data[4][spectrum_range] hhg_data[8][spectrum_range] hhg_data[12][spectrum_range]],
    yscale=:log10,

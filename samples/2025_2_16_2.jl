...
Ri_tsurf = rmax * 0.8
a0 = 0.5
po_func(r) = -1.07 * (r^2) ^ (-0.5) * flap_top_windows_f(r, 0, Ri_tsurf, 1/4, left_flag=false) * exp(-0.05 * (r^2 + a0) ^ (0.5))
...
# Store Data Manually
example_name = "2025_2_16_2_$(task_id)"

...
tmax = last(get_1c_thz_delay_list_ok(ω_fs, tau_fs, nc, ω_thz)) + 2 * 1 * pi / ω_thz
...
# t-data for Field
tau_list = get_1c_thz_delay_list_ok(ω_fs, tau_fs, nc, ω_thz, samples_num=tasks_num)
...
E_thz_1, E_thz_2, E_thz_3, tmax_thz = light_pulse(ω_thz, E_thz, 1, tau_thz, pulse_shape="sin2", phase1=0.5pi)

...
po_func(r) =    -1 / sqrt(r^2 + 0.1)              # potential function
rmax =          Nr * Δr     
...
k_num = 14
# k_num = 100
init_wave_list = itp_fdsh(pw, rt, k=k_num, err=1e-15);           # get initial wavefunctions by imaginary time propagation
...
# example_name = "2026_3_24_test_itp"
# eigen_states = Vector{shwave_t}(undef, 100)

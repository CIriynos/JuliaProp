...
# Basic Parameters
@expo grid_ratio = 1
@expo Nr =            40000 * grid_ratio           # number of radial grid points
...
# bound_state_num = sum([i^2 for i = 1: 20])
# eigen_states = retrieve_compact_bound_states("2026_4_26_itp_large_r", bound_state_num, pw.shgrid.l_num)

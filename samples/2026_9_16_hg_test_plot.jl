...
# Retrieve Data.
example_name = "2026_9_16_test_$(task_id)"
...
plot(hhg_k_linspace, [norm.(hhg_data_x_list[1][1:length(hhg_k_linspace)]) norm.(hhg_data_x_list[2][1:length(hhg_k_linspace)])], yscale=:log10)
plot(shg_yields)

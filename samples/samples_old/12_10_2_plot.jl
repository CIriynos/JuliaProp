...
tau_lst = [tau_fs - 2pi/ω2, tau_fs + nc1*pi/ω1 - 1.5pi/ω2,
    tau_fs + nc1*pi/ω1 - pi/ω2, tau_fs + nc1*pi/ω1 - 0.5pi/ω2, tau_fs + nc1*2pi/ω1]
...
plot([hhg_data[1][spectrum_range] hhg_data[2][spectrum_range] hhg_data[3][spectrum_range] hhg_data[4][spectrum_range] hhg_data[5][spectrum_range]],
    yscale=:log10,

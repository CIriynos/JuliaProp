...
p, hhg_data_x, hhg_data_y, base_id, hhg_k_linspace = get_hhg_spectrum_xy(hhg_integral_t, Et_datas[1], Et_datas[2],
    tau_fs + windows_time_delta, tmax - windows_time_delta, ω_fs, ts, Δt, max_display_rate=15, min_log_limit=1e-12)
...
pp = plot(hhg_k_linspace .* 0.05693, norm.(hhg_data_x_list[1][1:length(hhg_k_linspace)]), yscale=:log10, ylimits=(1e-15, 1e3))

...
# # Store Data Manually
# example_name = "2025_2_14_1_$(task_id)"
...
plot(hhg_k_linspace, [norm.(hhg_data_x_list[1][1:length(hhg_k_linspace)]) norm.(hhg_data_x_list[12][1:length(hhg_k_linspace)])], yscale=:log10)
...
# plot!(p2, unify(thz_data[2]) .- 0.08, unify(-thz_data[1]))

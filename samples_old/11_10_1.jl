...
# 11_10_1.jl  改THz和恒场大小，和论文中的一致 (20 ~ 50 kV/cm with 600 μJ)
# 扫延迟，扫很多个延迟(16个)，看最终波形长什么样？
# (ADD! 之前的结果很好，只不过中值处无法对应)
# 把频率加高，再试一下！
# 再减小一下E_fs -> 似乎没用
# 感觉THz有一个积累效应在里面！不妨延长一下演化时间？
...
# Propagation
hhg_integral_t, phi_record, dphi_record = tdse_elli_sh_mainloop_record_xy_hhg_long_prop(crt_shwave, pw, rt, At_data_x, At_data_y, steps, steps_laser, Ri_tsurf);

# Store Data
example_name = "11_10_1_$(tau_id)"

...
# 11_7_1.jl  跑二次谐波！用椭偏光，加外电场！omega改成/100，感觉原来的还是太大了

tau_list = [-10000, -6500, -4700, -2900]     # omega / 100
# tau_list = [-7000, -2850, -1950, -1000]        # omega / 50
...
ω2 = ω1 / 50    # 80 μm (9.375 THz ≈ 10 THz)

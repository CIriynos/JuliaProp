...
# 11_8_7.jl  改THz和恒场大小，和论文中的一致 (20 ~ 50 kV/cm with 600 μJ)
...
tau_lst = [500 - 2pi/ω2; range(500 - 2pi/ω2 + 400, 500 + nc1*2pi/ω1 - 400, 15)]
...
push!(shg_yields, hhg_spectrum[31])
